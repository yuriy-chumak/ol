...
4. Класс irrational чисел - это иррациональные (I) числа, представленные в машино-зависимом (и, обычно, неточном) виде. Поэтому в Scheme они называются "неточные" (inexact). Для перевода целых чисел в иррациональные и назад существуют функции exact и inexact. А также предикат проверки inexact?.
