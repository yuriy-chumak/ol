...
Списки являются первейшей конструкцией Lisp. Даже аббревиатура LISP расшифровывается как "обработчик списков" (LISt Processor). Более того, сама программа, которую дают выполнить Lisp'у - тоже список.
