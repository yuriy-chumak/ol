...
### Скачать (Download)
   ...
   Бинарные сборки на данный момент не доступны, но ведется работа по предоставлению готовых инсталляционных пакетов для Windows, Ubuntu Linux. Исходный код можно забрать на [странице проекта](https://github.com/yuriy-chumak/OL).
