...
* 2020
  ...
  * обновлена командная строка - теперь можно передавать дополнительные аргументы в ol-скрипт (обрабатывать через \*vm-args\*). ol-скрипты стали самостоятельными программами, ура.
