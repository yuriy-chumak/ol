...
### О проекте
  ...
  Вы можете использовать ol на Linux (CentOS, Debian, Fedora, RHEL, SLE, ScientificLinux, Uninvention, openSUSE, Ubuntu, etc.), Windows, *BSD, Android, WebOS, Odroid. Он работает под x86, arm, mips, ppc архитектурами на 32- и 64-битных платформах.
  ...
  * поддержка различных архитектур (x86, amd64, arm, mips)
