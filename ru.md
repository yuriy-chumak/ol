...
Ol реализован как расширенное подмножество Scheme [R<sup>5</sup>RS](http://www.schemers.org/Documents/Standards/R5RS/), включая, но не ограничиваясь, некоторыми из [SRFI](http://srfi.schemers.org/). Маленький, встраиваемый, кроссплатформенный (Linux, Windows, FreeBSD, NetBSD, OpenBSD).
  ...
  * маленькая и быстрая [виртуальной машина](?ru/internals/olvm) (всего 42 КБ в бинарном виде<sup>[*](#42kb)</sup>)
  * высокоэффективный [сборщик мусора](?ru/internals/memory) (благодаря чистой функциональности языка)
  * кроссплатформенность (Linux, Windows, FreeBSD, NetBSD, OpenBSD, [MacOS, webOS, Android, etc. - в реальных ближайших планах])
