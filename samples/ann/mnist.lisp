...
(gl:set-renderer (lambda (mouse)
   ...
   (when l0-l1
      ...
      (glLoadIdentity)
      (glOrtho (- (* 2 (ref l0 2))) (* 2 (ref l0 2)) (ref l0 1) (- (ref l0 1)) -1 1)
      ...
      (glLoadIdentity)
      (glOrtho (- (ref l1 2)) (ref l1 2) (* 10 (- (ref l1 1))) (* 10 (ref l1 1)) -1 1)
...
(define syn0/ (or ; первый слой нейросети
      (mread "syn0")
      (mrandom!
         (mnew (* (images 'number-of-rows) (images 'number-of-columns)) 128))))
