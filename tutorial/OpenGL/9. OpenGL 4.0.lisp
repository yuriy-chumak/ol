...
(define (glx:query-version)
   (let ((glx_major (raw type-vector-raw '(0 0 0 0)))
         (glx_minor (raw type-vector-raw '(0 0 0 0))))
      (or
...
(define num (raw type-vector-raw '(0 0 0 0)))
(define fbc
...
(define vi (glXChooseVisual display screen
   (raw type-vector-raw '(
     ...
     10 0 0 0  1 0 0 0 ; GLX_BLUE_SIZE
      ...
      0 0 0 0)))); None
(define fbc0 (raw type-port (vector->list (IN fbc 4))))
(print "fbc0: " fbc0)
...
(define context (glXCreateContextAttribs display fbc0 0 1 (raw type-vector-raw '(
